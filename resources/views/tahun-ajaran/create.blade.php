...
<div class="p-4 sm:p-8">
    <div class="bg-white rounded-3xl shadow-xl p-6 sm:p-10 border-t-8 border-teal-500 animate-slide-in-up">
        ...
        <form action="{{ route('tahun-ajaran.store') }}" method="POST" class="animate-slide-in-up" style="animation-delay: 0.4s;">
            @csrf
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="relative">
                        ...
                        <div class="relative mt-1">
                            <input type="number" name="tahun_mulai" id="tahun_mulai" value="{{ old('tahun_mulai') }}" class="block w-full rounded-lg border border-gray-300 shadow-sm pl-4 pr-10 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-300 hover:border-gray-400 @error('tahun_mulai') border-red-500 ring-red-200 @enderror" required>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative mt-1">
                            <input type="number" name="tahun_selesai" id="tahun_selesai" value="{{ old('tahun_selesai') }}" class="block w-full rounded-lg border border-gray-300 shadow-sm pl-4 pr-10 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-300 hover:border-gray-400 @error('tahun_selesai') border-red-500 ring-red-200 @enderror" required>
                            <i class="fas fa-calendar-alt absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none transition duration-300"></i>
                        </div>
                        @error('tahun_selesai')
                            <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" class="mr-3 h-5 w-5 text-teal-600 rounded focus:ring-teal-500 cursor-pointer transition-all duration-300 ease-in-out">
