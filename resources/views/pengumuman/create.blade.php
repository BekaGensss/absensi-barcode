...
<div class="p-4 sm:p-8">
    <div class="bg-white rounded-3xl shadow-xl p-6 sm:p-10 border-t-8 border-teal-500 animate-slide-in-up">
        ...
        <form action="{{ route('pengumuman.store') }}" method="POST" class="animate-slide-in-up" style="animation-delay: 0.4s;">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" checked class="mr-3 h-5 w-5 text-teal-600 rounded focus:ring-teal-500 cursor-pointer transition-all duration-300 ease-in-out">
